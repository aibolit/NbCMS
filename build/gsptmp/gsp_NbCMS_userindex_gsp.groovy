...
class gsp_NbCMS_userindex_gsp extends GroovyPage {
...
invokeTag('form','g',22,['action':("login"),'controller':("user")],1)
printHtmlPart(8)
}
...
public static final long LAST_MODIFIED = 1456966527489L
